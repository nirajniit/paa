...
@Component({
  selector: 'app-disapprovedbyadmin',
  templateUrl: './disapprovedbyadmin.component.html',
  styleUrls: ['./disapprovedbyadmin.component.css']
})
export class DisapprovedbyadminComponent implements OnInit{
  superForm  : any;
  formBuilder : any;
  apiService  : any;
  docPictureinput:any;
...
ngOnInit(): void {
  ...
  onSubmit()
  {
          ...
          this.apiService.updateVendorProduct(this.formData).subscribe(
            ...
            this.apiService.updateApprovedDisapproved().subscribe(
              (response : any) => {
