        ...
        this.apiService.user( TokenService.getToken() ).subscribe(
          (response: any) => {
            ...
            if (filteredUsers[0].roleId === "1") {
              ...
              this.router.navigate(['/superadmin.component',{ "Super_admin":filteredUsers[0].mobile}]);
              ...
              this.router.navigate(['/orderhistory.component', { "admin": filteredUsers[0].mobile }]);
              ...
              this.router.navigate(['vendorhome.component', { "vender": filteredUsers[0].mobile }]);         

            }

            else if (filteredUsers[0].roleId === "4") {
 
              this.router.navigate(['/merchant.component', { "marchant":filteredUsers[0].mobile }]);
