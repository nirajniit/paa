...
// @Component({
//   selector: 'app-super-admin-reapet',
//   templateUrl: './super-admin-reapet.component.html',
//   styleUrls: ['./super-admin-reapet.component.css']
// })
// export class SuperAdminReapetComponent {
...
export class SuperAdminReapetComponent implements OnInit {
  superForm  : any;
  formBuilder : any;
  apiService  : any;
  docPictureinput:any;
